...
### [x] 1.1 Serializing the store (Zustand)
...
### [x] 1.2 Version migrations (v1.0 save on v1.1)
...
### [x] 2.1 Layered Virtual File System
...
### [x] 2.2 Merging JSON patches over existing scenes
...
### [x] 3.1 Preloading strategies (video / audio)
...
### [x] 3.2 Heavy assets in a web context
...
### [x] 4.1 CLI (kata-cli) — watch .kata and compile to JSON
...
### [x] 4.2 VS Code extension for .kata syntax highlighting
...
### [x] 5.1 Headless Audio Manager (music layers, SFX, fading)
...
### [x] 6.1 Unify Conditional Syntax
